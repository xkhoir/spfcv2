...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Master Data Aturan</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Master Data Aturan</h3>
                    ...
                    <div class="card-body">
                        <table id="aturan" class="table table-bordered table-hover">
                            <thead>
                                <th>No</th>
...
<script>
    let _table = $('#aturan');
    let _url = "<?php echo base_url('aturan/datatables'); ?>";
