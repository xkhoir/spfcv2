...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Master Data Kerusakan</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Master Data Kerusakan</h3>
                    ...
                    <div class="card-body table-responsive">
                        <table id="kerusakan" class="table table-head-fixed table-bordered card-body table-responsive p-0">
                            <thead>
                                <th>No</th>
...
<script>
    ...
    let _url = "<?php echo base_url('master_kerusakan/kerusakan/datatables'); ?>";
