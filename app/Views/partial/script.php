...
<script src="<?php echo base_url('node_modules/tsparticles/tsparticles.min.js'); ?>"></script>
<!-- then include jquery wrapper -->
<script src="<?php echo base_url('node_modules/jquery-particles/dist/jquery.particles.min.js'); ?>"></script>
<!-- PaceJS -->
